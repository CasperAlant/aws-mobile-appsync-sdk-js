...
var encrypt = function (key, src) {
    ...
    sha256.update(src);
    var encryptedUInt8Array = sha256.digestSync();
    return new TextDecoder('utf-8').decode(encryptedUInt8Array);
};
...
var hash = function (src) {
    ...
    sha256.update(src);
    var hashUInt8Array = sha256.digestSync();
    return new TextDecoder('utf-8').decode(hashUInt8Array);
};
